...
h2_insn_t * genIterate(h2_insn_t * ptr, int FloatWidth)
{
	...
	h2_sValue_t u = {H2REGISTER, 'f', 1, (FloatWidth), 10, true};
	h2_sValue_t val = {H2REGISTER, 'f', 1, (FloatWidth), 11, true};
	h2_sValue_t div = {H2REGISTER, 'f', 1, (FloatWidth), 12, true};
	h2_sValue_t h2_outputVarName = {H2REGISTER, 'f', 1, (FloatWidth), 10, true};
	h2_sValue_t r = {H2REGISTER, 'f', 1, (FloatWidth), 0, true};
	h2_sValue_t tmp1 = {H2REGISTER, 'f', 1, (FloatWidth), 1, true};
	h2_sValue_t tmp2 = {H2REGISTER, 'f', 1, (FloatWidth), 2, true};
	h2_sValue_t tmp0000 = {H2REGISTER, 'f', 1, (FloatWidth), -1, false};
	h2_sValue_t tmp0001 = {H2REGISTER, 'f', 1, (FloatWidth), -1, false};
...
riscv_genW_3(SP, intReg32sValue(27), intsValue(8));
		tmp1 = riscv_genDIV_4(tmp1, val, u, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		tmp2 = riscv_genADD_3(tmp2, u, tmp1);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
			tmp0000 = riscv_genDIV_4(tmp0000, tmp2, div, immValueZero);
			h2_outputVarName = riscv_genMV_2(h2_outputVarName, tmp0000);
...
int main(int argc, char **argv)
{
    ...
    if(isFloat){
      return (next != sqrtf(af)) ? -1 : 0;
    }
    else{      
      return (next != sqrt(af)) ? -1 : 0;
    }
}
