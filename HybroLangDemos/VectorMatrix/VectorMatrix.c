...
h2_regSet_t h2_intRegSet, h2_fltRegSet, h2_vintRegSet, h2_vfltRegSet;
...
static void h2_ResetRegisterMasks(int intmask, int fltmask, int vectorintmask, int vectorfltmask)
{
  h2_intRegSet = intmask;
  h2_fltRegSet = fltmask;
  h2_vintRegSet = vectorintmask;
  h2_vfltRegSet = vectorfltmask;
}
...
{
  int count = 8 * sizeof (h2_regSet_t) - 1;
  h2_regSet_t tmpReg = h2_intRegSet;
  printf ("Reg %10s (%d)\n", msg, regNo);
...
h2_regSet_t h2_getReg ()
{
  /* Search for the 1st free register */
  h2_regSet_t tmpReg = h2_intRegSet;
  for (int i = 0; i < 8 * sizeof (h2_regSet_t); i++)
	{
	  if (tmpReg % 2 == 0)
		{						/* Free register found */
		  h2_intRegSet = h2_intRegSet | (1 << i); /* Update regSet */
...
{
  if (v >= 9) // Specific AARCH64
    {
      h2_intRegSet = h2_intRegSet & ~(1 << v); /* Update regSet */
#ifdef H2_DEBUG_REGISTER
...
/* No label table to avoid C warning for empty table ... */
	...
	#endif // H2_DEBUG_REGISTER
	h2_ResetRegisterMasks(0xffff01ff, 0, 0, 0);
	...
	tmp0001 = aarch64_genR_3(tmp0002, tmp0001, immValueZero);
	tmp0003 = aarch64_genMUL_3(tmp0003, tmp0001, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)((m[0][0]))});
	h2_freeReg(tmp0002.regNro); tmp0002.regNro = -1;
	tmp0004 = aarch64_genADD_3(tmp0004, i, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)(4)});
	tmp0004 = aarch64_genR_3(tmp0005, tmp0004, immValueZero);
	tmp0006 = aarch64_genMUL_3(tmp0006, tmp0004, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)((m[1][0]))});
	h2_freeReg(tmp0005.regNro); tmp0005.regNro = -1;
	tmp0007 = aarch64_genADD_3(tmp0007, tmp0003, tmp0006);
	h2_freeReg(tmp0003.regNro); tmp0003.regNro = -1;
	h2_freeReg(tmp0006.regNro); tmp0006.regNro = -1;
	tmp0008 = aarch64_genADD_3(tmp0008, i, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)(8)});
	tmp0008 = aarch64_genR_3(tmp0009, tmp0008, immValueZero);
	tmp0010 = aarch64_genMUL_3(tmp0010, tmp0008, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)((m[2][0]))});
	h2_freeReg(tmp0009.regNro); tmp0009.regNro = -1;
	tmp0011 = aarch64_genADD_3(tmp0011, tmp0007, tmp0010);
	h2_freeReg(tmp0007.regNro); tmp0007.regNro = -1;
	h2_freeReg(tmp0010.regNro); tmp0010.regNro = -1;
	tmp0012 = aarch64_genADD_3(tmp0012, i, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)(12)});
	tmp0012 = aarch64_genR_3(tmp0013, tmp0012, immValueZero);
	tmp0014 = aarch64_genMUL_3(tmp0014, tmp0012, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)((m[3][0]))});
	h2_freeReg(tmp0013.regNro); tmp0013.regNro = -1;
	tmp0015 = aarch64_genADD_3(tmp0015, tmp0011, tmp0014);
	h2_freeReg(tmp0011.regNro); tmp0011.regNro = -1;
	h2_freeReg(tmp0014.regNro); tmp0014.regNro = -1;
	aarch64_genW_3(tmp0000, tmp0015, immValueZero);
	h2_freeReg(tmp0000.regNro); tmp0000.regNro = -1;
	h2_freeReg(tmp0015.regNro); tmp0015.regNro = -1;
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_ResetRegisterMasks(0xffff01ff, 0, 0, 0);
	tmp0016 = aarch64_genADD_3(tmp0016, o, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)(4)});
	tmp0017 = aarch64_genADD_3(tmp0017, i, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)(0)});
	tmp0017 = aarch64_genR_3(tmp0018, tmp0017, immValueZero);
	tmp0019 = aarch64_genMUL_3(tmp0019, tmp0017, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)((m[0][1]))});
	h2_freeReg(tmp0018.regNro); tmp0018.regNro = -1;
	tmp0020 = aarch64_genADD_3(tmp0020, i, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)(4)});
	tmp0020 = aarch64_genR_3(tmp0021, tmp0020, immValueZero);
	tmp0022 = aarch64_genMUL_3(tmp0022, tmp0020, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)((m[1][1]))});
	h2_freeReg(tmp0021.regNro); tmp0021.regNro = -1;
	tmp0023 = aarch64_genADD_3(tmp0023, tmp0019, tmp0022);
	h2_freeReg(tmp0019.regNro); tmp0019.regNro = -1;
	h2_freeReg(tmp0022.regNro); tmp0022.regNro = -1;
	tmp0024 = aarch64_genADD_3(tmp0024, i, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)(8)});
	tmp0024 = aarch64_genR_3(tmp0025, tmp0024, immValueZero);
	tmp0026 = aarch64_genMUL_3(tmp0026, tmp0024, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)((m[2][1]))});
	h2_freeReg(tmp0025.regNro); tmp0025.regNro = -1;
	tmp0027 = aarch64_genADD_3(tmp0027, tmp0023, tmp0026);
	h2_freeReg(tmp0023.regNro); tmp0023.regNro = -1;
	h2_freeReg(tmp0026.regNro); tmp0026.regNro = -1;
	tmp0028 = aarch64_genADD_3(tmp0028, i, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)(12)});
	tmp0028 = aarch64_genR_3(tmp0029, tmp0028, immValueZero);
	tmp0030 = aarch64_genMUL_3(tmp0030, tmp0028, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)((m[3][1]))});
	h2_freeReg(tmp0029.regNro); tmp0029.regNro = -1;
	tmp0031 = aarch64_genADD_3(tmp0031, tmp0027, tmp0030);
	h2_freeReg(tmp0027.regNro); tmp0027.regNro = -1;
	h2_freeReg(tmp0030.regNro); tmp0030.regNro = -1;
	aarch64_genW_3(tmp0016, tmp0031, immValueZero);
	h2_freeReg(tmp0016.regNro); tmp0016.regNro = -1;
	h2_freeReg(tmp0031.regNro); tmp0031.regNro = -1;
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_ResetRegisterMasks(0xffff01ff, 0, 0, 0);
	tmp0032 = aarch64_genADD_3(tmp0032, o, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)(8)});
	tmp0033 = aarch64_genADD_3(tmp0033, i, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)(0)});
	tmp0033 = aarch64_genR_3(tmp0034, tmp0033, immValueZero);
	tmp0035 = aarch64_genMUL_3(tmp0035, tmp0033, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)((m[0][2]))});
	h2_freeReg(tmp0034.regNro); tmp0034.regNro = -1;
	tmp0036 = aarch64_genADD_3(tmp0036, i, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)(4)});
	tmp0036 = aarch64_genR_3(tmp0037, tmp0036, immValueZero);
	tmp0038 = aarch64_genMUL_3(tmp0038, tmp0036, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)((m[1][2]))});
	h2_freeReg(tmp0037.regNro); tmp0037.regNro = -1;
	tmp0039 = aarch64_genADD_3(tmp0039, tmp0035, tmp0038);
	h2_freeReg(tmp0035.regNro); tmp0035.regNro = -1;
	h2_freeReg(tmp0038.regNro); tmp0038.regNro = -1;
	tmp0040 = aarch64_genADD_3(tmp0040, i, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)(8)});
	tmp0040 = aarch64_genR_3(tmp0041, tmp0040, immValueZero);
	tmp0042 = aarch64_genMUL_3(tmp0042, tmp0040, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)((m[2][2]))});
	h2_freeReg(tmp0041.regNro); tmp0041.regNro = -1;
	tmp0043 = aarch64_genADD_3(tmp0043, tmp0039, tmp0042);
	h2_freeReg(tmp0039.regNro); tmp0039.regNro = -1;
	h2_freeReg(tmp0042.regNro); tmp0042.regNro = -1;
	tmp0044 = aarch64_genADD_3(tmp0044, i, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)(12)});
	tmp0044 = aarch64_genR_3(tmp0045, tmp0044, immValueZero);
	tmp0046 = aarch64_genMUL_3(tmp0046, tmp0044, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)((m[3][2]))});
	h2_freeReg(tmp0045.regNro); tmp0045.regNro = -1;
	tmp0047 = aarch64_genADD_3(tmp0047, tmp0043, tmp0046);
	h2_freeReg(tmp0043.regNro); tmp0043.regNro = -1;
	h2_freeReg(tmp0046.regNro); tmp0046.regNro = -1;
	aarch64_genW_3(tmp0032, tmp0047, immValueZero);
	h2_freeReg(tmp0032.regNro); tmp0032.regNro = -1;
	h2_freeReg(tmp0047.regNro); tmp0047.regNro = -1;
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_ResetRegisterMasks(0xffff01ff, 0, 0, 0);
	tmp0048 = aarch64_genADD_3(tmp0048, o, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)(12)});
	tmp0049 = aarch64_genADD_3(tmp0049, i, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)(0)});
	tmp0049 = aarch64_genR_3(tmp0050, tmp0049, immValueZero);
	tmp0051 = aarch64_genMUL_3(tmp0051, tmp0049, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)((m[0][3]))});
	h2_freeReg(tmp0050.regNro); tmp0050.regNro = -1;
	tmp0052 = aarch64_genADD_3(tmp0052, i, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)(4)});
	tmp0052 = aarch64_genR_3(tmp0053, tmp0052, immValueZero);
	tmp0054 = aarch64_genMUL_3(tmp0054, tmp0052, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)((m[1][3]))});
	h2_freeReg(tmp0053.regNro); tmp0053.regNro = -1;
	tmp0055 = aarch64_genADD_3(tmp0055, tmp0051, tmp0054);
	h2_freeReg(tmp0051.regNro); tmp0051.regNro = -1;
	h2_freeReg(tmp0054.regNro); tmp0054.regNro = -1;
	tmp0056 = aarch64_genADD_3(tmp0056, i, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)(8)});
	tmp0056 = aarch64_genR_3(tmp0057, tmp0056, immValueZero);
	tmp0058 = aarch64_genMUL_3(tmp0058, tmp0056, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)((m[2][3]))});
	h2_freeReg(tmp0057.regNro); tmp0057.regNro = -1;
	tmp0059 = aarch64_genADD_3(tmp0059, tmp0055, tmp0058);
	h2_freeReg(tmp0055.regNro); tmp0055.regNro = -1;
	h2_freeReg(tmp0058.regNro); tmp0058.regNro = -1;
	tmp0060 = aarch64_genADD_3(tmp0060, i, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)(12)});
	tmp0060 = aarch64_genR_3(tmp0061, tmp0060, immValueZero);
	tmp0062 = aarch64_genMUL_3(tmp0062, tmp0060, (h2_sValue_t) {VALUE, 'i', 1, 32, 0, (int)((m[3][3]))});
	h2_freeReg(tmp0061.regNro); tmp0061.regNro = -1;
	tmp0063 = aarch64_genADD_3(tmp0063, tmp0059, tmp0062);
	h2_freeReg(tmp0059.regNro); tmp0059.regNro = -1;
	h2_freeReg(tmp0062.regNro); tmp0062.regNro = -1;
	aarch64_genW_3(tmp0048, tmp0063, immValueZero);
	h2_freeReg(tmp0048.regNro); tmp0048.regNro = -1;
	h2_freeReg(tmp0063.regNro); tmp0063.regNro = -1;
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_ResetRegisterMasks(0xffff01ff, 0, 0, 0);
