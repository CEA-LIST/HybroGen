...
#define RV32I_BNE_RRI_I_32_1(r1,r2,i1) do /* BNE */ { 	riscv_G32((((i1 >> 12) & 0x1) << 31)|(((i1 >> 5) & 0x3f) << 25)|((r2 & 0x1f) << 20)|((r1 & 0x1f) << 15)|((0x1 & 0x7) << 12)|(((i1 >> 1) & 0xf) << 8)|(((i1 >> 11) & 0x1) << 7)|((0x63 & 0x7f) >> 0)); } while(0);
...
#define RV32I_BGT_RRI_I_32_1(r2,r1,i1) do /* BGT */ { 	riscv_G32((((i1 >> 12) & 0x1) << 31)|(((i1 >> 5) & 0x3f) << 25)|((r2 & 0x1f) << 20)|((r1 & 0x1f) << 15)|((0x4 & 0x7) << 12)|(((i1 >> 1) & 0xf) << 8)|(((i1 >> 11) & 0x1) << 7)|((0x63 & 0x7f) >> 0)); } while(0);
...
h2_sValue_t riscv_genBGT_3(h2_sValue_t P0,h2_sValue_t P1,h2_sValue_t P2);
h2_sValue_t riscv_genRET_0();
h2_sValue_t riscv_genADD_3(h2_sValue_t P0,h2_sValue_t P1,h2_sValue_t P2);
h2_sValue_t riscv_genBNE_3(h2_sValue_t P0,h2_sValue_t P1,h2_sValue_t P2);
...
// No specific optimisation for BGT/riscv
    ...
    if ((P0.arith == 'i') && (P0.wLen <= 32) && (P0.vLen == 1) && P0.ValOrReg == H2REGISTER && P1.ValOrReg == H2REGISTER && P2.ValOrReg == H2VALUE)
    {
	RV32I_BGT_RRI_I_32_1(P0.regNro, P1.regNro, P2.valueImm);
	return P0;
    }
...
// No specific optimisation for BNE/riscv
    ...
    if ((P0.arith == 'i') && (P0.wLen <= 32) && (P0.vLen == 1) && P0.ValOrReg == H2REGISTER && P1.ValOrReg == H2REGISTER && P2.ValOrReg == H2VALUE)
    {
	RV32I_BNE_RRI_I_32_1(P0.regNro, P1.regNro, P2.valueImm);
	return P0;
    }
...
{
	/* Code Generation of 29 instructions */
	/* Symbol table :*/
	/*VarName = {ValOrLen, arith, vectorLen, wordLen, regNo, ValueImm, dontFree} */
	h2_sValue_t plus = {H2REGISTER, 'i', 1, 32, 10, true};
	h2_sValue_t LoopValue = {H2REGISTER, 'i', 1, 32, 11, true};
	h2_sValue_t h2_outputVarName = {H2REGISTER, 'i', 1, 32, 10, true};
	h2_sValue_t tmp = {H2REGISTER, 'i', 1, 32, 5, true};
	h2_sValue_t i = {H2REGISTER, 'i', 1, 32, 6, true};
	h2_sValue_t reste = {H2REGISTER, 'i', 1, 32, 7, true};
...
h2_insn_t   * labelAddresses []={
	...
	h2_initRegisterMasks(0xFFF, 0, 0, 0);
...
riscv_genW_3(SP, intReg32sValue(27), intsValue(8));
		tmp = riscv_genMV_2(tmp, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(1)});
	#ifdef H2_DEBUG_REGISTER
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		plus = riscv_genBNE_3(plus, tmp, intsValue((labelAddresses [h2_iffalse_00000010] - h2_asm_pc)*4));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		i = riscv_genMV_2(i, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(1)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		i = riscv_genBGT_3(i, LoopValue, intsValue((labelAddresses [h2_end_00000002] - h2_asm_pc)*4));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		tmp = riscv_genMUL_4(tmp, tmp, i, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_endtrue_00000009);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	intReg32sValue(0) = riscv_genBA_2(intReg32sValue(0), intsValue((labelAddresses [h2_ifend_00000011] - h2_asm_pc)*4));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_iffalse_00000010);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		i = riscv_genBGT_3(i, LoopValue, intsValue((labelAddresses [h2_end_00000006] - h2_asm_pc)*4));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		tmp = riscv_genADD_3(tmp, tmp, i);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_ifend_00000011);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		h2_outputVarName = riscv_genMV_2(h2_outputVarName, tmp);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	h2_asm_pc = labelAddresses [h2_prologue_00000008];
		plus = riscv_genBNE_3(plus, tmp, intsValue((labelAddresses [h2_iffalse_00000010] - h2_asm_pc)*4));
