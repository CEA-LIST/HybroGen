...
h2_insn_t * genIf(h2_insn_t * ptr)
{
	...
	h2_sValue_t LoopValue = {H2REGISTER, 'i', 1, 32, 10, true};
...
riscv_genW_3(SP, intReg32sValue(27), intsValue(8));
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		i = riscv_genBGE_3(i, LoopValue, intsValue((labelAddresses [h2_end_00000006] - h2_asm_pc)*4));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
			tmp0002 = riscv_genDIV_4(tmp0002, i, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(2)}, immValueZero);
		reste = riscv_genMUL_4(reste, tmp0002, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(2)}, immValueZero);
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		i = riscv_genBNE_3(i, reste, intsValue((labelAddresses [h2_iffalse_00000002] - h2_asm_pc)*4));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_endtrue_00000001);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	intReg32sValue(0) = riscv_genBA_2(intReg32sValue(0), intsValue((labelAddresses [h2_ifend_00000003] - h2_asm_pc)*4));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_iffalse_00000002);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		tmp = riscv_genADD_3(tmp, tmp, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(0)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_ifend_00000003);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	h2_asm_pc = labelAddresses [h2_begin_00000005];
		i = riscv_genBGE_3(i, LoopValue, intsValue((labelAddresses [h2_end_00000006] - h2_asm_pc)*4));
	h2_asm_pc = labelAddresses [h2_prologue_00000000];
		i = riscv_genBNE_3(i, reste, intsValue((labelAddresses [h2_iffalse_00000002] - h2_asm_pc)*4));
