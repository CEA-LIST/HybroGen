...
h2_insn_t   * labelAddresses []={
	...
	h2_initRegisterMasks(0x7FF, 0, 0, 0);
...
riscv_genW_3(SP, intReg32sValue(27), intsValue(8));
		tmp = riscv_genMV_2(tmp, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(0)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_prologue_00000012);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_begin_00000013);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		i = riscv_genBGE_3(i, len, intsValue((labelAddresses [h2_end_00000014] - h2_asm_pc)*4));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		j = riscv_genMV_2(j, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(0)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		j = riscv_genBGE_3(j, len, intsValue((labelAddresses [h2_end_00000002] - h2_asm_pc)*4));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		tmp = riscv_genADD_3(tmp, tmp, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(10)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		j = riscv_genADD_3(j, j, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(1)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		tmp = riscv_genADD_3(tmp, tmp, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(1)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_prologue_00000004);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_begin_00000005);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		j = riscv_genBGE_3(j, len, intsValue((labelAddresses [h2_end_00000006] - h2_asm_pc)*4));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		tmp = riscv_genADD_3(tmp, tmp, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(11)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_BA_00000007);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	intReg32sValue(0) = riscv_genBA_2(intReg32sValue(0), intsValue((labelAddresses [h2_begin_00000005] - h2_asm_pc)*4));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_end_00000006);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_prologue_00000008);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_begin_00000009);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		j = riscv_genBGE_3(j, len, intsValue((labelAddresses [h2_end_00000010] - h2_asm_pc)*4));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_BA_00000011);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	intReg32sValue(0) = riscv_genBA_2(intReg32sValue(0), intsValue((labelAddresses [h2_begin_00000009] - h2_asm_pc)*4));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_end_00000010);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_BA_00000015);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	intReg32sValue(0) = riscv_genBA_2(intReg32sValue(0), intsValue((labelAddresses [h2_begin_00000013] - h2_asm_pc)*4));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_end_00000014);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_prologue_00000020);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_begin_00000021);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		i = riscv_genBGE_3(i, len, intsValue((labelAddresses [h2_end_00000022] - h2_asm_pc)*4));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_prologue_00000016);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_begin_00000017);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		j = riscv_genBGE_3(j, len, intsValue((labelAddresses [h2_end_00000018] - h2_asm_pc)*4));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		tmp = riscv_genADD_3(tmp, tmp, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(7)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_BA_00000019);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	intReg32sValue(0) = riscv_genBA_2(intReg32sValue(0), intsValue((labelAddresses [h2_begin_00000017] - h2_asm_pc)*4));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_end_00000018);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_BA_00000023);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	intReg32sValue(0) = riscv_genBA_2(intReg32sValue(0), intsValue((labelAddresses [h2_begin_00000021] - h2_asm_pc)*4));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	riscv_genLABEL_1(h2_end_00000022);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		h2_outputVarName = riscv_genADD_3(h2_outputVarName, tmp, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(1)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	h2_asm_pc = labelAddresses [h2_begin_00000013];
		i = riscv_genBGE_3(i, len, intsValue((labelAddresses [h2_end_00000014] - h2_asm_pc)*4));
	h2_asm_pc = labelAddresses [h2_begin_00000001];
		j = riscv_genBGE_3(j, len, intsValue((labelAddresses [h2_end_00000002] - h2_asm_pc)*4));
	h2_asm_pc = labelAddresses [h2_BA_00000003];
	intReg32sValue(0) = riscv_genBA_2(intReg32sValue(0), intsValue((labelAddresses [h2_begin_00000001] - h2_asm_pc)*4));
	h2_asm_pc = labelAddresses [h2_begin_00000005];
		j = riscv_genBGE_3(j, len, intsValue((labelAddresses [h2_end_00000006] - h2_asm_pc)*4));
	h2_asm_pc = labelAddresses [h2_BA_00000007];
	intReg32sValue(0) = riscv_genBA_2(intReg32sValue(0), intsValue((labelAddresses [h2_begin_00000005] - h2_asm_pc)*4));
	h2_asm_pc = labelAddresses [h2_begin_00000009];
		j = riscv_genBGE_3(j, len, intsValue((labelAddresses [h2_end_00000010] - h2_asm_pc)*4));
	h2_asm_pc = labelAddresses [h2_BA_00000011];
	intReg32sValue(0) = riscv_genBA_2(intReg32sValue(0), intsValue((labelAddresses [h2_begin_00000009] - h2_asm_pc)*4));
	h2_asm_pc = labelAddresses [h2_BA_00000015];
	intReg32sValue(0) = riscv_genBA_2(intReg32sValue(0), intsValue((labelAddresses [h2_begin_00000013] - h2_asm_pc)*4));
	h2_asm_pc = labelAddresses [h2_begin_00000021];
		i = riscv_genBGE_3(i, len, intsValue((labelAddresses [h2_end_00000022] - h2_asm_pc)*4));
	h2_asm_pc = labelAddresses [h2_begin_00000017];
		j = riscv_genBGE_3(j, len, intsValue((labelAddresses [h2_end_00000018] - h2_asm_pc)*4));
