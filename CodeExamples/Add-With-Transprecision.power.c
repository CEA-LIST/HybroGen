...
h2_insn_t * genAdd(h2_insn_t * ptr, int FloatWidth)
{
	...
	h2_sValue_t a = {H2REGISTER, 'f', 1, (FloatWidth), 1, true};
	h2_sValue_t b = {H2REGISTER, 'f', 1, (FloatWidth), 2, true};
	h2_sValue_t h2_outputVarName = {H2REGISTER, 'f', 1, (FloatWidth), 1, true};
	h2_sValue_t r = {H2REGISTER, 'f', 1, (FloatWidth), 14, true};
	h2_sValue_t tmp0000 = {H2REGISTER, 'f', 1, (FloatWidth), -1, false};
...
int main(int argc, char * argv[])
{
  ...
  in1  = atof(argv[2]);
  fPtr1 = h2_malloc (1024);  // Allocate memory for 1024 instructions
  fPtr2 = h2_malloc (1024);  // Allocate memory for 1024 instructions
#if 0
  ...
  fPtr1 = (pifff)genAdd (fPtr1, 32); // Generate instructions
  resf  = fPtr1(in0, in1);         // Call generated code
  printf("(%d) %10.30f + %10.30f = %10.30f\n", 32, in0, in1, resf);

  fPtr2 = (pifdd)genAdd (fPtr2, 64); // Generate instructions
