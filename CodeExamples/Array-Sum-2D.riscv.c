...
{
	/* Code Generation of 20 instructions */
	/* Symbol table :*/
	/*VarName = {ValOrLen, arith, vectorLen, wordLen, regNo, ValueImm, dontFree} */
	h2_sValue_t a = {H2REGISTER, 'i', 1, 32, 10, true};
	h2_sValue_t nLine = {H2REGISTER, 'i', 1, 32, 11, true};
	h2_sValue_t nColumn = {H2REGISTER, 'i', 1, 32, 12, true};
	h2_sValue_t h2_outputVarName = {H2REGISTER, 'i', 1, 32, 10, true};
	h2_sValue_t line = {H2REGISTER, 'i', 1, 32, 5, true};
	h2_sValue_t column = {H2REGISTER, 'i', 1, 32, 6, true};
	h2_sValue_t sum = {H2REGISTER, 'i', 1, 32, 7, true};
...
h2_insn_t   * labelAddresses []={
	...
	h2_initRegisterMasks(0x1FFF, 0, 0, 0);
...
riscv_genW_3(SP, intReg32sValue(27), intsValue(8));
		sum = riscv_genMV_2(sum, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(0)});
	#ifdef H2_DEBUG_REGISTER
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		line = riscv_genMV_2(line, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(0)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		line = riscv_genBGE_3(line, nLine, intsValue((labelAddresses [h2_end_00000006] - h2_asm_pc)*4));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		column = riscv_genMV_2(column, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(0)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		column = riscv_genBGE_3(column, nColumn, intsValue((labelAddresses [h2_end_00000002] - h2_asm_pc)*4));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
								tmp0003 = riscv_genMUL_4(tmp0003, line, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)((stride))}, immValueZero);
							tmp0004 = riscv_genADD_3(tmp0004, tmp0003, column);
					...
					if (!tmp0005.dontFree) h2_freeReg(tmp0004.regNro);
						tmp0006 = riscv_genADD_3(tmp0006, a, tmp0005);
				if (!tmp0006.dontFree) h2_freeReg(tmp0005.regNro);
				tmp0007 = riscv_genR_3(tmp0007, tmp0006, immValueZero);
				tmp0008 = riscv_genADD_3(tmp0008, sum, tmp0007);
		if (!tmp0008.dontFree) h2_freeReg(tmp0007.regNro);
		sum = riscv_genADD_3(sum, tmp0008, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)((constant))});
	if (!sum.dontFree) h2_freeReg(tmp0008.regNro);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		column = riscv_genADD_3(column, column, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(1)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		line = riscv_genADD_3(line, line, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(1)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		h2_outputVarName = riscv_genMV_2(h2_outputVarName, sum);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
