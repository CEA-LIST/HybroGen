...
h2_insn_t * genC2F(h2_insn_t * ptr)
{
	...
	h2_sValue_t r = {H2REGISTER, 'i', 1, 32, 14, true};
...
/* No label table to avoid C warning for empty table ... */
	...
	h2_initRegisterMasks(0x780F, 0, 0, 0);
	h2_resetRegisterMasks();
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask initialization\n");
	#endif // H2_DEBUG_REGISTER
	
				tmp0000 = power_genMUL_3(tmp0000, a, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(9)});
			tmp0001 = power_genDIV_3(tmp0001, tmp0000, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(5)});
		if (!tmp0001.dontFree) h2_freeReg(tmp0000.regNro);
		r = power_genADD_3(r, tmp0001, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(32)});
...
/* No label table to avoid C warning for empty table ... */
	...
	printf("Tmp registers mask initialization\n");
		...
		r = power_genSUB_3(r, a, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(32)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
			tmp0000 = power_genMUL_3(tmp0000, r, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(5)});
		r = power_genDIV_3(r, tmp0000, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(9)});
