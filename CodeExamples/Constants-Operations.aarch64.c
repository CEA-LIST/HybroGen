...
/* No label table to avoid C warning for empty table ... */
	...
	h2_initRegisterMasks(0xFFFF0300, 0, 0, 0);
	h2_resetRegisterMasks();
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask initialization\n");
	#endif // H2_DEBUG_REGISTER
	
		r = aarch64_genADD_3(r, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(42)}, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)((b))});
	#ifdef H2_DEBUG_REGISTER
...
/* No label table to avoid C warning for empty table ... */
	...
	printf("Tmp registers mask initialization\n");
		...
		r = aarch64_genSUB_3(r, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(42)}, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)((b))});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
...
/* No label table to avoid C warning for empty table ... */
	...
	printf("Tmp registers mask initialization\n");
		...
		r = aarch64_genMUL_3(r, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(42)}, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)((b))});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
...
/* No label table to avoid C warning for empty table ... */
	...
	printf("Tmp registers mask initialization\n");
		...
		r = aarch64_genDIV_3(r, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(42)}, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)((b))});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
