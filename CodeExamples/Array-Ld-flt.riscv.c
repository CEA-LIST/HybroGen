...
#define RV32F_FLW_RRI_F_32_1(r2,r1,i1) do /* R */ { 	riscv_G32(((i1 & 0xfff) << 20)|((r1 & 0x1f) << 15)|((0x2 & 0x7) << 12)|((r2 & 0x1f) << 7)|((0x7 & 0x7f) >> 0)); } while(0);
#define RV64D_FLW_RRI_F_64_1(r2,r1,i1) do /* R */ { 	riscv_G32(((i1 & 0xfff) << 20)|((r1 & 0x1f) << 15)|((0x3 & 0x7) << 12)|((r2 & 0x1f) << 7)|((0x7 & 0x7f) >> 0)); } while(0);
...
// No specific optimisation for R/riscv
    ...
    {
	RV32F_FLW_RRI_F_32_1(P0.regNro, P1.regNro, P2.valueImm);
	return P0;
    }

    if ((P0.arith == 'f') && (P0.wLen <= 64) && (P0.vLen == 1) && P0.ValOrReg == H2REGISTER && P1.ValOrReg == H2REGISTER && P2.ValOrReg == H2VALUE)
    {
	RV64D_FLW_RRI_F_64_1(P0.regNro, P1.regNro, P2.valueImm);
	return P0;
    }
...
h2_insn_t * genLoad(h2_insn_t * ptr, int wordSize)
{
	...
	h2_sValue_t index = {H2REGISTER, 'i', 1, 32, 11, true};
	h2_sValue_t h2_outputVarName = {H2REGISTER, 'f', 1, 32, 10, true};
	h2_sValue_t tmp = {H2REGISTER, 'f', 1, (wordSize), 0, true};
...
riscv_genW_3(SP, intReg32sValue(27), intsValue(8));
					tmp0000 = riscv_genMUL_4(tmp0000, index, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)((1 * (wordSize)) / 8)}, immValueZero);
					tmp0001 = riscv_genADD_3(tmp0001, a, tmp0000);
			if (!tmp0001.dontFree) h2_freeReg(tmp0000.regNro);
			tmp0002 = riscv_genR_3(tmp0002, tmp0001, immValueZero);
			h2_outputVarName = riscv_genMV_2(h2_outputVarName, tmp0002);
