...
{
	/* Code Generation of 12 instructions */
	/* Symbol table :*/
	...
	h2_sValue_t l = {H2REGISTER, 'i', 1, 32, 15, true};
	...
	h2_sValue_t tmp0004 = {H2REGISTER, 'i', 1, 64, -1, false};
...
h2_insn_t   * labelAddresses []={
	...
	h2_initRegisterMasks(0xF80F, 0, 0, 0);
	h2_resetRegisterMasks();
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask initialization\n");
	#endif // H2_DEBUG_REGISTER
	
		l = power_genMV_2(l, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)((len))});
	#ifdef H2_DEBUG_REGISTER
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
				tmp0002 = power_genMUL_3(tmp0002, i, (h2_sValue_t) {H2VALUE, 'i', 1, 64, 0, (int)((1 * 32) / 8)});
				tmp0003 = power_genADD_3(tmp0003, a, tmp0002);
		if (!tmp0003.dontFree) h2_freeReg(tmp0002.regNro);
						tmp0004 = power_genMUL_3(tmp0004, i, (h2_sValue_t) {H2VALUE, 'i', 1, 64, 0, (int)((1 * 32) / 8)});
						tmp0005 = power_genADD_3(tmp0005, a, tmp0004);
				if (!tmp0005.dontFree) h2_freeReg(tmp0004.regNro);
				tmp0006 = power_genR_3(tmp0006, tmp0005, immValueZero);
			tmp0007 = power_genMUL_3(tmp0007, tmp0006, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)((b))});
		if (!tmp0007.dontFree) h2_freeReg(tmp0006.regNro);
		power_genW_3(tmp0003, tmp0007, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
