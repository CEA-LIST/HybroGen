...
#define P1_BNE_I_I_32_1(i0) do /* bne */ { 	power_G32(((0x4082 & 0xffff) << 16)|((i0 & 0x3fff) << 2)|((0x0 & 0x3) >> 0)); } while(0);
...
h2_sValue_t power_genBNE_1(h2_sValue_t P0);
...
{
#ifdef H2_DEBUG_INSN
	printf ("Start code gen for BNE instruction\n");
	printf ("ValOrReg / arith / wLen / vLen / regNro / valueImm\n");
	printf ("P%d: %s/%c/%d/%d/%d\n", 0, (0==P0.ValOrReg)?"REG":"VAL", P0.arith, P0.wLen, P0.vLen, P0.valueImm);
#endif // H2_DEBUG_INSN
// No generic optimisation for BNE

// No specific optimisation for BNE/power
    ...
    if ((P0.arith == 'i') && (P0.wLen <= 32) && (P0.vLen == 1) && P0.ValOrReg == H2VALUE)
    {
	P1_BNE_I_I_32_1(P0.valueImm);
	return P0;
    }
	printf ("Warning, BNE instruction generation failed\n");
	h2_codeGenerationOK = false;
	printf ("ValOrReg / arith / wLen / vLen / regNro / valueImm\n");	printf ("P%d: %s/%c/%d/%d/%d\n", 0, (0==P0.ValOrReg)?"REG":"VAL", P0.arith, P0.wLen, P0.vLen, P0.valueImm);return immValueZero;
}
h2_sValue_t power_genADD_3(h2_sValue_t P0,h2_sValue_t P1,h2_sValue_t P2)
...
h2_insn_t * genIf(h2_insn_t * ptr)
{
	...
	h2_sValue_t LoopValue = {H2REGISTER, 'i', 1, 32, 3, true};
	h2_sValue_t h2_outputVarName = {H2REGISTER, 'i', 1, 32, 3, true};
	h2_sValue_t tmp = {H2REGISTER, 'i', 1, 32, 14, true};
	h2_sValue_t i = {H2REGISTER, 'i', 1, 32, 15, true};
	h2_sValue_t reste = {H2REGISTER, 'i', 1, 32, 16, true};
...
h2_insn_t   * labelAddresses []={
	...
	0, /* h2_endtrue_00000001 */
	#define h2_endtrue_00000001 1
	0, /* h2_iffalse_00000002 */
	#define h2_iffalse_00000002 2
	0, /* h2_ifend_00000003 */
	#define h2_ifend_00000003 3
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
			tmp0002 = power_genDIV_3(tmp0002, i, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(2)});
		reste = power_genMUL_3(reste, tmp0002, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(2)});
	if (!reste.dontFree) h2_freeReg(tmp0002.regNro);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		i = power_genCMP_2(i, reste);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	power_genBNE_1(intsValue((labelAddresses [h2_iffalse_00000002] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		tmp = power_genADD_3(tmp, tmp, i);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	power_genLABEL_1(h2_endtrue_00000001);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	power_genBA_1(intsValue((labelAddresses [h2_ifend_00000003] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	power_genLABEL_1(h2_iffalse_00000002);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		tmp = power_genADD_3(tmp, tmp, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(0)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	power_genLABEL_1(h2_ifend_00000003);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		h2_outputVarName = power_genMV_2(h2_outputVarName, tmp);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	power_genBGE_1(intsValue((labelAddresses [h2_end_00000006] - h2_asm_pc)));
	h2_asm_pc = labelAddresses [h2_prologue_00000000] + 1;
	power_genBNE_1(intsValue((labelAddresses [h2_iffalse_00000002] - h2_asm_pc)));
	h2_asm_pc = labelAddresses [h2_endtrue_00000001];
	power_genBA_1(intsValue((labelAddresses [h2_ifend_00000003] - h2_asm_pc)));
