...
h2_insn_t * genMul(h2_insn_t * ptr) /* C compilette prototype */
{
	...
	h2_sValue_t increment = {H2REGISTER, 'i', 1, 32, 0, true};
	h2_sValue_t len = {H2REGISTER, 'i', 1, 32, 1, true};
	h2_sValue_t h2_outputVarName = {H2REGISTER, 'i', 1, 32, 0, true};
	h2_sValue_t res = {H2REGISTER, 'i', 1, 32, 9, true};
	h2_sValue_t i = {H2REGISTER, 'i', 1, 32, 10, true};
	h2_sValue_t j = {H2REGISTER, 'i', 1, 32, 11, true};
	h2_sValue_t k = {H2REGISTER, 'i', 1, 32, 12, true};
...
h2_insn_t   * labelAddresses []={
	...
	h2_initRegisterMasks(0xFFFF1F03, 0, 0, 0);
	h2_resetRegisterMasks();
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask initialization\n");
	#endif // H2_DEBUG_REGISTER
	
		res = aarch64_genMV_3(res, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(0)}, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		res = aarch64_genADD_3(res, res, increment);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		h2_outputVarName = aarch64_genMV_3(h2_outputVarName, res, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
