...
#define A64_B_GT_I_I_64_1(i0) do /* bgt */ { 	aarch64_G32(((0x54 & 0xff) << 24)|((i0 & 0x7ffff) << 5)|((0xc & 0x1f) >> 0)); } while(0);
#define A64_B_NE_I_I_64_1(i0) do /* bne */ { 	aarch64_G32(((0x54 & 0xff) << 24)|((i0 & 0x7ffff) << 5)|((0x1 & 0x1f) >> 0)); } while(0);
...
h2_sValue_t aarch64_genBNE_1(h2_sValue_t P0);
h2_sValue_t aarch64_genRET_0();
h2_sValue_t aarch64_genBGT_1(h2_sValue_t P0);
...
// No specific optimisation for BNE/aarch64
...
// No specific optimisation for BGT/aarch64
...
h2_insn_t * genPlusOrMul(h2_insn_t * ptr)
{
	...
	h2_sValue_t plus = {H2REGISTER, 'i', 1, 32, 0, true};
	h2_sValue_t LoopValue = {H2REGISTER, 'i', 1, 32, 1, true};
	h2_sValue_t h2_outputVarName = {H2REGISTER, 'i', 1, 32, 0, true};
	h2_sValue_t tmp = {H2REGISTER, 'i', 1, 32, 9, true};
	h2_sValue_t i = {H2REGISTER, 'i', 1, 32, 10, true};
	h2_sValue_t reste = {H2REGISTER, 'i', 1, 32, 11, true};
...
h2_insn_t   * labelAddresses []={
	...
	h2_initRegisterMasks(0xFFFF0F03, 0, 0, 0);
	h2_resetRegisterMasks();
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask initialization\n");
	#endif // H2_DEBUG_REGISTER
	
		tmp = aarch64_genMV_3(tmp, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(1)}, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		plus = aarch64_genCMP_2(plus, tmp);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genBNE_1(intsValue((labelAddresses [h2_iffalse_00000010] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		i = aarch64_genMV_3(i, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(1)}, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		i = aarch64_genCMP_2(i, LoopValue);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genBGT_1(intsValue((labelAddresses [h2_end_00000002] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		tmp = aarch64_genMUL_3(tmp, tmp, i);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_endtrue_00000009);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genBA_1(intsValue((labelAddresses [h2_ifend_00000011] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_iffalse_00000010);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genBGT_1(intsValue((labelAddresses [h2_end_00000006] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		tmp = aarch64_genADD_3(tmp, tmp, i);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_ifend_00000011);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		h2_outputVarName = aarch64_genMV_3(h2_outputVarName, tmp, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
