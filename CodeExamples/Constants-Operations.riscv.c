...
/* No label table to avoid C warning for empty table ... */
	...
	h2_initRegisterMasks(0x33F, 0, 0, 0);
...
riscv_genW_3(SP, intReg32sValue(27), intsValue(8));
		r = riscv_genADD_3(r, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(42)}, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)((b))});
	#ifdef H2_DEBUG_REGISTER
...
riscv_genW_3(SP, intReg32sValue(26), intsValue(12));
riscv_genW_3(SP, intReg32sValue(27), intsValue(8));
		r = riscv_genSUB_3(r, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(42)}, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)((b))});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
...
riscv_genW_3(SP, intReg32sValue(26), intsValue(12));
riscv_genW_3(SP, intReg32sValue(27), intsValue(8));
		r = riscv_genMUL_4(r, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(42)}, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)((b))}, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
...
riscv_genW_3(SP, intReg32sValue(26), intsValue(12));
riscv_genW_3(SP, intReg32sValue(27), intsValue(8));
		r = riscv_genDIV_4(r, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(42)}, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)((b))}, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
