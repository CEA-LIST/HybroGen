...
#define A64_B_I_I_64_1(i0) do /* ba */ { 	aarch64_G32(((0x5 & 0x3f) << 26)|((i0 & 0x3ffffff) >> 0)); } while(0);
#define A64_CMP_RR_I_64_1(r1,r2) do /* cmp */ { 	aarch64_G32(((0x758 & 0x7ff) << 21)|((r2 & 0x1f) << 16)|((0x0 & 0x3f) << 10)|((r1 & 0x1f) << 5)|((0x1f & 0x1f) >> 0)); } while(0);
...
#define A64_B_GE_I_I_64_1(i0) do /* bge */ { 	aarch64_G32(((0x54 & 0xff) << 24)|((i0 & 0x7ffff) << 5)|((0xa & 0x1f) >> 0)); } while(0);
h2_sValue_t aarch64_genBA_1(h2_sValue_t P0);
h2_sValue_t aarch64_genSL_3(h2_sValue_t P0,h2_sValue_t P1,h2_sValue_t P2);
h2_sValue_t aarch64_genCMP_2(h2_sValue_t P0,h2_sValue_t P1);
...
h2_sValue_t aarch64_genBGE_1(h2_sValue_t P0);
...
// No specific optimisation for BA/aarch64

	if ((P0.ValOrReg == H2REGISTER) && (P0.regNro == -1))
		P0.regNro = h2_getReg();

    if ((P0.arith == 'i') && (P0.wLen <= 64) && (P0.vLen == 1) && P0.ValOrReg == H2VALUE)
    {
	A64_B_I_I_64_1(P0.valueImm);
	return P0;
    }
...
// No specific optimisation for CMP/aarch64
    ...
    {
	A64_CMP_RR_I_64_1(P0.regNro, P1.regNro);
	return P0;
    }
...
// No specific optimisation for BGE/aarch64
...
h2_insn_t * genLoopNest(h2_insn_t * ptr) /* C compilette prototype */
{
	...
	h2_sValue_t len = {H2REGISTER, 'i', 1, 32, 0, true};
	h2_sValue_t h2_outputVarName = {H2REGISTER, 'i', 1, 32, 0, true};
	h2_sValue_t i = {H2REGISTER, 'i', 1, 32, 9, true};
	h2_sValue_t j = {H2REGISTER, 'i', 1, 32, 10, true};
	h2_sValue_t tmp = {H2REGISTER, 'i', 1, 32, 11, true};
	...
	/* Label  table :*/
#define aarch64_genLABEL_1(LABEL_ID) labelAddresses[LABEL_ID] = h2_asm_pc;
h2_insn_t   * labelAddresses []={
	...
	h2_initRegisterMasks(0xFFFF0F01, 0, 0, 0);
	h2_resetRegisterMasks();
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask initialization\n");
	#endif // H2_DEBUG_REGISTER
	
		tmp = aarch64_genMV_3(tmp, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(0)}, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_prologue_00000012);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		i = aarch64_genMV_3(i, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(0)}, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_begin_00000013);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		i = aarch64_genCMP_2(i, len);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genBGE_1(intsValue((labelAddresses [h2_end_00000014] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_prologue_00000000);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		j = aarch64_genMV_3(j, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(0)}, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_begin_00000001);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		j = aarch64_genCMP_2(j, len);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genBGE_1(intsValue((labelAddresses [h2_end_00000002] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		tmp = aarch64_genADD_3(tmp, tmp, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(10)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		j = aarch64_genADD_3(j, j, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(1)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_BA_00000003);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genBA_1(intsValue((labelAddresses [h2_begin_00000001] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_end_00000002);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		tmp = aarch64_genADD_3(tmp, tmp, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(1)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_prologue_00000004);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_begin_00000005);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genBGE_1(intsValue((labelAddresses [h2_end_00000006] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		tmp = aarch64_genADD_3(tmp, tmp, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(11)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_BA_00000007);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genBA_1(intsValue((labelAddresses [h2_begin_00000005] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_end_00000006);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_prologue_00000008);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_begin_00000009);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genBGE_1(intsValue((labelAddresses [h2_end_00000010] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_BA_00000011);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genBA_1(intsValue((labelAddresses [h2_begin_00000009] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_end_00000010);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		i = aarch64_genADD_3(i, i, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(1)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_BA_00000015);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genBA_1(intsValue((labelAddresses [h2_begin_00000013] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_end_00000014);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_prologue_00000020);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_begin_00000021);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genBGE_1(intsValue((labelAddresses [h2_end_00000022] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_prologue_00000016);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_begin_00000017);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genBGE_1(intsValue((labelAddresses [h2_end_00000018] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		tmp = aarch64_genADD_3(tmp, tmp, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(7)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_BA_00000019);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genBA_1(intsValue((labelAddresses [h2_begin_00000017] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_end_00000018);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_BA_00000023);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genBA_1(intsValue((labelAddresses [h2_begin_00000021] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_end_00000022);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		h2_outputVarName = aarch64_genADD_3(h2_outputVarName, tmp, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(1)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
