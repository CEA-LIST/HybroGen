...
h2_insn_t * genIf(h2_insn_t * ptr, int selectedValue)
{
	...
	h2_sValue_t value = {H2REGISTER, 'i', 1, 32, 3, true};
	h2_sValue_t h2_outputVarName = {H2REGISTER, 'i', 1, 32, 3, true};
	h2_sValue_t tmp = {H2REGISTER, 'i', 1, 32, 14, true};
	h2_sValue_t threshold = {H2REGISTER, 'i', 1, 31, 15, true};
	h2_sValue_t tmp0000 = {H2REGISTER, 'i', 1, 31, -1, false};
...
h2_insn_t   * labelAddresses []={
	...
	printf("Tmp registers mask initialization\n");
		...
		threshold = power_genMV_2(threshold, (h2_sValue_t) {H2VALUE, 'i', 1, 31, 0, (int)((selectedValue))});
	#ifdef H2_DEBUG_REGISTER
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		value = power_genCMP_2(value, threshold);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
