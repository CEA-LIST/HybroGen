...
#define A64_STR_RRI_F_8_1(r0,r1,i0) do /* w */ { 	aarch64_G32(((0x1e0 & 0x7ff) << 21)|((i0 & 0x1ff) << 12)|((0x1 & 0x3) << 10)|((r0 & 0x1f) << 5)|((r1 & 0x1f) >> 0)); } while(0);
#define A64_STR_RRI_F_16_1(r0,r1,i0) do /* w */ { 	aarch64_G32(((0x3e0 & 0x7ff) << 21)|((i0 & 0x1ff) << 12)|((0x1 & 0x3) << 10)|((r0 & 0x1f) << 5)|((r1 & 0x1f) >> 0)); } while(0);
#define A64_STUR_RRI_F_32_1(r0,r1,i0) do /* w */ { 	aarch64_G32(((0x5e0 & 0x7ff) << 21)|((i0 & 0x1ff) << 12)|((0x0 & 0x3) << 10)|((r0 & 0x1f) << 5)|((r1 & 0x1f) >> 0)); } while(0);
#define A64_ST1_RR_F_32_4(r0,r1) do /* w */ { 	aarch64_G32(((0x13001e & 0x3fffff) << 10)|((r0 & 0x1f) << 5)|((r1 & 0x1f) >> 0)); } while(0);
#define A64_STUR_RRI_F_64_1(r0,r1,i0) do /* w */ { 	aarch64_G32(((0x7e0 & 0x7ff) << 21)|((i0 & 0x1ff) << 12)|((0x0 & 0x3) << 10)|((r0 & 0x1f) << 5)|((r1 & 0x1f) >> 0)); } while(0);
#define A64_STR_RRI_F_128_1(r0,r1,i0) do /* w */ { 	aarch64_G32(((0x1e4 & 0x7ff) << 21)|((i0 & 0x1ff) << 12)|((0x1 & 0x3) << 10)|((r0 & 0x1f) << 5)|((r1 & 0x1f) >> 0)); } while(0);
...
if (isValue(P1))
  { // Store constant (Should use RRI variant)
    ...
    if ((P1.arith == 'f') && (P1.wLen <= 32) && (P1.vLen == 4) && P0.ValOrReg == H2REGISTER && P1.ValOrReg == H2REGISTER)
    {
	A64_ST1_RR_F_32_4(P0.regNro, P1.regNro);
	return P1;
    }
    ...
    if ((P1.arith == 'f') && (P1.wLen <= 8) && (P1.vLen == 1) && P0.ValOrReg == H2REGISTER && P1.ValOrReg == H2REGISTER && P2.ValOrReg == H2VALUE)
    {
	A64_STR_RRI_F_8_1(P0.regNro, P1.regNro, P2.valueImm);
	return P1;
    }

    if ((P1.arith == 'f') && (P1.wLen <= 16) && (P1.vLen == 1) && P0.ValOrReg == H2REGISTER && P1.ValOrReg == H2REGISTER && P2.ValOrReg == H2VALUE)
    {
	A64_STR_RRI_F_16_1(P0.regNro, P1.regNro, P2.valueImm);
	return P1;
    }

    if ((P1.arith == 'f') && (P1.wLen <= 32) && (P1.vLen == 1) && P0.ValOrReg == H2REGISTER && P1.ValOrReg == H2REGISTER && P2.ValOrReg == H2VALUE)
    {
	A64_STUR_RRI_F_32_1(P0.regNro, P1.regNro, P2.valueImm);
	return P1;
    }

    if ((P1.arith == 'f') && (P1.wLen <= 64) && (P1.vLen == 1) && P0.ValOrReg == H2REGISTER && P1.ValOrReg == H2REGISTER && P2.ValOrReg == H2VALUE)
    {
	A64_STUR_RRI_F_64_1(P0.regNro, P1.regNro, P2.valueImm);
	return P1;
    }

    if ((P1.arith == 'f') && (P1.wLen <= 128) && (P1.vLen == 1) && P0.ValOrReg == H2REGISTER && P1.ValOrReg == H2REGISTER && P2.ValOrReg == H2VALUE)
    {
	A64_STR_RRI_F_128_1(P0.regNro, P1.regNro, P2.valueImm);
	return P1;
    }
...
h2_insn_t * gen_Array_St(h2_insn_t * ptr, int wordSize)
{
	...
	h2_sValue_t value = {H2REGISTER, 'f', 1, (wordSize), 0, true};
...
/* No label table to avoid C warning for empty table ... */
	...
	printf("Tmp registers mask initialization\n");
		...
		aarch64_genW_3(tmp0001, value, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		h2_outputVarName = aarch64_genMV_3(h2_outputVarName, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(1)}, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
