...
h2_insn_t * genAdd(h2_insn_t * ptr, int FloatWidth)
{
	...
	h2_sValue_t a = {H2REGISTER, 'f', 1, (FloatWidth), 0, true};
	h2_sValue_t b = {H2REGISTER, 'f', 1, (FloatWidth), 1, true};
	h2_sValue_t h2_outputVarName = {H2REGISTER, 'f', 1, (FloatWidth), 0, true};
	h2_sValue_t r = {H2REGISTER, 'f', 1, (FloatWidth), 12, true};
