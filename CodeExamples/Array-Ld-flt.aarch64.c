...
#define A64_LDR_RRI_F_32_1(r0,r1,i0) do /* r */ { 	aarch64_G32(((0x5e2 & 0x7ff) << 21)|((i0 & 0x1ff) << 12)|((0x1 & 0x3) << 10)|((r1 & 0x1f) << 5)|((r0 & 0x1f) >> 0)); } while(0);
#define A64_LDR_RRR_F_32_1(r0,r1,r2) do /* r */ { 	aarch64_G32(((0x5e3 & 0x7ff) << 21)|((r2 & 0x1f) << 16)|((0x36 & 0x3f) << 10)|((r1 & 0x1f) << 5)|((r0 & 0x1f) >> 0)); } while(0);
#define A64_LD1_RR_F_32_4(r0,r1) do /* r */ { 	aarch64_G32(((0x13101e & 0x3fffff) << 10)|((r1 & 0x1f) << 5)|((r0 & 0x1f) >> 0)); } while(0);
#define A64_LDR_RRI_F_64_1(r0,r1,i0) do /* r */ { 	aarch64_G32(((0x3f5 & 0x3ff) << 22)|((i0 & 0xfff) << 10)|((r1 & 0x1f) << 5)|((r0 & 0x1f) >> 0)); } while(0);
...
// No specific optimisation for R/aarch64
    ...
    if ((P0.arith == 'f') && (P0.wLen <= 32) && (P0.vLen == 4) && P0.ValOrReg == H2REGISTER && P1.ValOrReg == H2REGISTER)
    {
	A64_LD1_RR_F_32_4(P0.regNro, P1.regNro);
	return P0;
    }
...
h2_insn_t * genLoad(h2_insn_t * ptr, int wordSize)
{
	...
	h2_sValue_t index = {H2REGISTER, 'i', 1, 32, 1, true};
	h2_sValue_t h2_outputVarName = {H2REGISTER, 'f', 1, 32, 0, true};
	h2_sValue_t tmp = {H2REGISTER, 'f', 1, (wordSize), 12, true};
...
/* No label table to avoid C warning for empty table ... */
	...
	printf("Tmp registers mask initialization\n");
					...
					tmp0000 = aarch64_genMUL_3(tmp0000, index, (h2_sValue_t) {H2VALUE, 'i', 1, 64, 0, (int)((1 * (wordSize)) / 8)});
					tmp0001 = aarch64_genADD_3(tmp0001, a, tmp0000);
			if (!tmp0001.dontFree) h2_freeReg(tmp0000.regNro);
			tmp0002 = aarch64_genR_3(tmp0002, tmp0001, immValueZero);
			h2_outputVarName = aarch64_genMV_3(h2_outputVarName, tmp0002, immValueZero);
