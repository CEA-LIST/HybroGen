...
h2_insn_t * genIf(h2_insn_t * ptr)
{
	...
	h2_sValue_t LoopValue = {H2REGISTER, 'i', 1, 32, 0, true};
...
h2_insn_t   * labelAddresses []={
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
			tmp0002 = aarch64_genDIV_3(tmp0002, i, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(2)});
		reste = aarch64_genMUL_3(reste, tmp0002, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(2)});
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		i = aarch64_genCMP_2(i, reste);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genBNE_1(intsValue((labelAddresses [h2_iffalse_00000002] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_endtrue_00000001);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genBA_1(intsValue((labelAddresses [h2_ifend_00000003] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_iffalse_00000002);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		tmp = aarch64_genADD_3(tmp, tmp, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(0)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	aarch64_genLABEL_1(h2_ifend_00000003);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
