...
h2_insn_t * gen_Array_St(h2_insn_t * ptr, int wordSize)
{
	...
	h2_sValue_t value = {H2REGISTER, 'i', 1, (wordSize), 12, true};
...
riscv_genW_3(SP, intReg32sValue(27), intsValue(8));
		...
		riscv_genW_3(tmp0001, value, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		h2_outputVarName = riscv_genMV_2(h2_outputVarName, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(1)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
