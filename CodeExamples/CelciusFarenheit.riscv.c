...
h2_insn_t * genC2F(h2_insn_t * ptr)
{
	...
	h2_sValue_t r = {H2REGISTER, 'i', 1, 32, 5, true};
...
/* No label table to avoid C warning for empty table ... */
	...
	h2_initRegisterMasks(0x73F, 0, 0, 0);
...
riscv_genW_3(SP, intReg32sValue(27), intsValue(8));
				tmp0000 = riscv_genMUL_4(tmp0000, a, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(9)}, immValueZero);
			tmp0001 = riscv_genDIV_4(tmp0001, tmp0000, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(5)}, immValueZero);
		if (!tmp0001.dontFree) h2_freeReg(tmp0000.regNro);
		r = riscv_genADD_3(r, tmp0001, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(32)});
...
riscv_genW_3(SP, intReg32sValue(26), intsValue(12));
riscv_genW_3(SP, intReg32sValue(27), intsValue(8));
		r = riscv_genSUB_3(r, a, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(32)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
			tmp0000 = riscv_genMUL_4(tmp0000, r, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(5)}, immValueZero);
		r = riscv_genDIV_4(r, tmp0000, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(9)}, immValueZero);
