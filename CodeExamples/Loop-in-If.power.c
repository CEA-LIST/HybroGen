...
#define P1_BGT_I_I_32_1(i0) do /* bgt */ { 	power_G32(((0x4181 & 0xffff) << 16)|((i0 & 0x3fff) << 2)|((0x0 & 0x3) >> 0)); } while(0);
...
h2_sValue_t power_genBGT_1(h2_sValue_t P0);
...
{
#ifdef H2_DEBUG_INSN
	printf ("Start code gen for BGT instruction\n");
	printf ("ValOrReg / arith / wLen / vLen / regNro / valueImm\n");
	printf ("P%d: %s/%c/%d/%d/%d\n", 0, (0==P0.ValOrReg)?"REG":"VAL", P0.arith, P0.wLen, P0.vLen, P0.valueImm);
#endif // H2_DEBUG_INSN
// No generic optimisation for BGT

// No specific optimisation for BGT/power
    ...
    if ((P0.arith == 'i') && (P0.wLen <= 32) && (P0.vLen == 1) && P0.ValOrReg == H2VALUE)
    {
	P1_BGT_I_I_32_1(P0.valueImm);
	return P0;
    }
	printf ("Warning, BGT instruction generation failed\n");
	h2_codeGenerationOK = false;
	printf ("ValOrReg / arith / wLen / vLen / regNro / valueImm\n");	printf ("P%d: %s/%c/%d/%d/%d\n", 0, (0==P0.ValOrReg)?"REG":"VAL", P0.arith, P0.wLen, P0.vLen, P0.valueImm);return immValueZero;
}
h2_sValue_t power_genRET_0()
...
h2_insn_t * genPlusOrMul(h2_insn_t * ptr)
{
	...
	h2_sValue_t plus = {H2REGISTER, 'i', 1, 32, 3, true};
	h2_sValue_t LoopValue = {H2REGISTER, 'i', 1, 32, 4, true};
...
h2_insn_t   * labelAddresses []={
	...
	0, /* h2_endtrue_00000009 */
	#define h2_endtrue_00000009 9
	0, /* h2_iffalse_00000010 */
	#define h2_iffalse_00000010 10
	0, /* h2_ifend_00000011 */
	#define h2_ifend_00000011 11
	};

	h2_asm_pc = (h2_insn_t *) ptr;
	h2_codeGenerationOK = true;
	h2_codeGenTime = h2_getticks();
	h2_initRegisterMasks(0x1F81F, 0, 0, 0);
	h2_resetRegisterMasks();
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask initialization\n");
	#endif // H2_DEBUG_REGISTER
	
		tmp = power_genMV_2(tmp, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(1)});
	#ifdef H2_DEBUG_REGISTER
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		plus = power_genCMP_2(plus, tmp);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	power_genBNE_1(intsValue((labelAddresses [h2_iffalse_00000010] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		i = power_genMV_2(i, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(1)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	power_genBGT_1(intsValue((labelAddresses [h2_end_00000002] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		tmp = power_genMUL_3(tmp, tmp, i);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	power_genLABEL_1(h2_endtrue_00000009);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	power_genBA_1(intsValue((labelAddresses [h2_ifend_00000011] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	power_genLABEL_1(h2_iffalse_00000010);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	power_genBGT_1(intsValue((labelAddresses [h2_end_00000006] - h2_asm_pc)));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	power_genLABEL_1(h2_ifend_00000011);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	h2_asm_pc = labelAddresses [h2_prologue_00000008] + 1;
	power_genBNE_1(intsValue((labelAddresses [h2_iffalse_00000010] - h2_asm_pc)));
	h2_asm_pc = labelAddresses [h2_begin_00000001] + 1;
	power_genBGT_1(intsValue((labelAddresses [h2_end_00000002] - h2_asm_pc)));
	h2_asm_pc = labelAddresses [h2_BA_00000003];
	power_genBA_1(intsValue((labelAddresses [h2_begin_00000001] - h2_asm_pc)));
	h2_asm_pc = labelAddresses [h2_endtrue_00000009];
	power_genBA_1(intsValue((labelAddresses [h2_ifend_00000011] - h2_asm_pc)));
