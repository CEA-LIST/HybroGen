...
h2_insn_t * genMul(h2_insn_t * ptr) /* C compilette prototype */
{
	...
	h2_sValue_t increment = {H2REGISTER, 'i', 1, 32, 10, true};
	h2_sValue_t len = {H2REGISTER, 'i', 1, 32, 11, true};
	h2_sValue_t h2_outputVarName = {H2REGISTER, 'i', 1, 32, 10, true};
	h2_sValue_t res = {H2REGISTER, 'i', 1, 32, 5, true};
	h2_sValue_t i = {H2REGISTER, 'i', 1, 32, 6, true};
	h2_sValue_t j = {H2REGISTER, 'i', 1, 32, 7, true};
	h2_sValue_t k = {H2REGISTER, 'i', 1, 32, 28, true};
...
h2_insn_t   * labelAddresses []={
	...
	h2_initRegisterMasks(0x10000FFF, 0, 0, 0);
...
riscv_genW_3(SP, intReg32sValue(27), intsValue(8));
		res = riscv_genMV_2(res, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(0)});
	#ifdef H2_DEBUG_REGISTER
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		i = riscv_genBGE_3(i, len, intsValue((labelAddresses [h2_end_00000002] - h2_asm_pc)*4));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		res = riscv_genADD_3(res, res, increment);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		h2_outputVarName = riscv_genMV_2(h2_outputVarName, res);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
