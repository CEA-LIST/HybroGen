...
#define P1_LFS_RRI_F_32_1(r0,r1,i0) do /* r */ { 	power_G32(((0x30 & 0x3f) << 26)|((r0 & 0x1f) << 21)|((r1 & 0x1f) << 16)|((i0 & 0xffff) >> 0)); } while(0);
...
// No specific optimisation for R/power
    ...
    if ((P0.arith == 'f') && (P0.wLen <= 32) && (P0.vLen == 1) && P0.ValOrReg == H2REGISTER && P1.ValOrReg == H2REGISTER && P2.ValOrReg == H2VALUE)
    {
	P1_LFS_RRI_F_32_1(P0.regNro, P1.regNro, P2.valueImm);
	return P0;
    }
...
h2_insn_t * genLoad(h2_insn_t * ptr, int wordSize)
{
	...
	h2_sValue_t tmp = {H2REGISTER, 'f', 1, (wordSize), 14, true};
	h2_sValue_t tmp0000 = {H2REGISTER, 'i', 1, 64, -1, false};
	h2_sValue_t tmp0001 = {H2REGISTER, 'i', 1, 64, -1, false};
	h2_sValue_t tmp0002 = {H2REGISTER, 'f', 1, (wordSize), -1, false};
	h2_sValue_t tmp0003 = {H2REGISTER, 'f', 1, (wordSize), -1, false};
...
/* No label table to avoid C warning for empty table ... */
	...
	printf("Tmp registers mask initialization\n");
			...
			tmp0002 = power_genR_3(tmp0002, tmp0001, immValueZero);
			h2_outputVarName = power_genMV_2(h2_outputVarName, tmp0002);
