...
h2_insn_t * genAdd(h2_insn_t * ptr, int wordSize)
{
	...
	h2_sValue_t h2_outputVarName = {H2REGISTER, 'i', 1, (wordSize), 3, true};
	h2_sValue_t tmp = {H2REGISTER, 'i', 1, (wordSize), 14, true};
	h2_sValue_t tmp0000 = {H2REGISTER, 'i', 1, 64, -1, false};
	h2_sValue_t tmp0001 = {H2REGISTER, 'i', 1, 64, -1, false};
	h2_sValue_t tmp0002 = {H2REGISTER, 'i', 1, (wordSize), -1, false};
	h2_sValue_t tmp0003 = {H2REGISTER, 'i', 1, (wordSize), -1, false};
...
int main(int argc, char * argv[])
{
  ...
  resultOK = 0;
  printf ("Size of 10 INTs %ld, SHORTs %ld, CHARs %ld \n", sizeof (a32), sizeof (a16), sizeof (a8));
