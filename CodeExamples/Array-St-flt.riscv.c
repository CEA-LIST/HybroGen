...
#define RV32F_FSW_RRI_F_32_1(r1,r2,i1) do /* W */ { 	riscv_G32((((i1 >> 5) & 0x7f) << 25)|((r2 & 0x1f) << 20)|((r1 & 0x1f) << 15)|((0x2 & 0x7) << 12)|((i1 & 0x1f) << 7)|((0x27 & 0x7f) >> 0)); } while(0);
#define RV64D_FSW_RRI_F_64_1(r1,r2,i1) do /* W */ { 	riscv_G32((((i1 >> 5) & 0x7f) << 25)|((r2 & 0x1f) << 20)|((r1 & 0x1f) << 15)|((0x3 & 0x7) << 12)|((i1 & 0x1f) << 7)|((0x27 & 0x7f) >> 0)); } while(0);
...
if (isValue(P1))
  { // Store constant (Should use RRI variant)
    ...
    {
	RV32F_FSW_RRI_F_32_1(P0.regNro, P1.regNro, P2.valueImm);
	return P1;
    }

    if ((P1.arith == 'f') && (P1.wLen <= 64) && (P1.vLen == 1) && P0.ValOrReg == H2REGISTER && P1.ValOrReg == H2REGISTER && P2.ValOrReg == H2VALUE)
    {
	RV64D_FSW_RRI_F_64_1(P0.regNro, P1.regNro, P2.valueImm);
	return P1;
    }
...
h2_insn_t * gen_Array_St(h2_insn_t * ptr, int wordSize)
{
	...
	h2_sValue_t value = {H2REGISTER, 'f', 1, (wordSize), 10, true};
