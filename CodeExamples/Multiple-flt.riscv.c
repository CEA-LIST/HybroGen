...
#define RV32F_FADD_S_RRR_F_32_1(r3,r1,r2) do /* ADD */ { 	riscv_G32(((0x0 & 0x7f) << 25)|((r2 & 0x1f) << 20)|((r1 & 0x1f) << 15)|((0x0 & 0x7) << 12)|((r3 & 0x1f) << 7)|((0x53 & 0x7f) >> 0)); } while(0);
#define RV32D_FADD_D_RRR_F_64_1(r3,r1,r2) do /* ADD */ { 	riscv_G32(((0x1 & 0x7f) << 25)|((r2 & 0x1f) << 20)|((r1 & 0x1f) << 15)|((0x0 & 0x7) << 12)|((r3 & 0x1f) << 7)|((0x53 & 0x7f) >> 0)); } while(0);
...
#define RV32F_FDIV_S_RRR_F_32_1(r3,r1,r2) do /* DIV */ { 	riscv_G32(((0xc & 0x7f) << 25)|((r2 & 0x1f) << 20)|((r1 & 0x1f) << 15)|((0x0 & 0x7) << 12)|((r3 & 0x1f) << 7)|((0x53 & 0x7f) >> 0)); } while(0);
#define RV32D_FDIV_D_RRR_F_64_1(r3,r1,r2) do /* DIV */ { 	riscv_G32(((0xd & 0x7f) << 25)|((r2 & 0x1f) << 20)|((r1 & 0x1f) << 15)|((0x0 & 0x7) << 12)|((r3 & 0x1f) << 7)|((0x53 & 0x7f) >> 0)); } while(0);
#define RV32F_FMUL_S_RRR_F_32_1(r3,r1,r2) do /* MUL */ { 	riscv_G32(((0x8 & 0x7f) << 25)|((r2 & 0x1f) << 20)|((r1 & 0x1f) << 15)|((0x0 & 0x7) << 12)|((r3 & 0x1f) << 7)|((0x53 & 0x7f) >> 0)); } while(0);
...
#define RV32F_FSUB_S_RRR_F_32_1(r3,r1,r2) do /* SUB */ { 	riscv_G32(((0x4 & 0x7f) << 25)|((r2 & 0x1f) << 20)|((r1 & 0x1f) << 15)|((0x0 & 0x7) << 12)|((r3 & 0x1f) << 7)|((0x53 & 0x7f) >> 0)); } while(0);
#define RV32F_FMV_S_RR_F_32_1(r3,r1) do /* MV */ { 	riscv_G32(((0x10 & 0x7f) << 25)|((r1 & 0x1f) << 20)|((r1 & 0x1f) << 15)|((0x0 & 0x7) << 12)|((r3 & 0x1f) << 7)|((0x53 & 0x7f) >> 0)); } while(0);
#define RV32D_FMV_D_RR_F_64_1(r3,r1) do /* MV */ { 	riscv_G32(((0x11 & 0x7f) << 25)|((r1 & 0x1f) << 20)|((r1 & 0x1f) << 15)|((0x0 & 0x7) << 12)|((r3 & 0x1f) << 7)|((0x53 & 0x7f) >> 0)); } while(0);
...
if  (isValue(P2))
{
    ...
    {
	RV32F_FMUL_S_RRR_F_32_1(P0.regNro, P1.regNro, P2.regNro);
	return P0;
    }
...
if  ((P2.ValOrReg == H2VALUE) && (P2.arith == 'i'))
{
    ...
    if ((P0.arith == 'f') && (P0.wLen <= 32) && (P0.vLen == 1) && P0.ValOrReg == H2REGISTER && P1.ValOrReg == H2REGISTER && P2.ValOrReg == H2REGISTER)
    {
	RV32F_FSUB_S_RRR_F_32_1(P0.regNro, P1.regNro, P2.regNro);
	return P0;
    }
...
h2_insn_t * genAddf(h2_insn_t * ptr)
{
	...
	h2_sValue_t a = {H2REGISTER, 'f', 1, 32, 10, true};
	h2_sValue_t b = {H2REGISTER, 'f', 1, 32, 11, true};
	h2_sValue_t h2_outputVarName = {H2REGISTER, 'f', 1, 32, 10, true};
	h2_sValue_t r = {H2REGISTER, 'f', 1, 32, 0, true};
...
/* No label table to avoid C warning for empty table ... */
	...
	h2_initRegisterMasks(0x31F, 0, 0, 0);
...
riscv_genW_3(SP, intReg32sValue(27), intsValue(8));
		r = riscv_genADD_3(r, a, b);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		h2_outputVarName = riscv_genMV_2(h2_outputVarName, r);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
...
riscv_genW_3(SP, intReg32sValue(26), intsValue(12));
riscv_genW_3(SP, intReg32sValue(27), intsValue(8));
		r = riscv_genMUL_4(r, a, b, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
...
riscv_genW_3(SP, intReg32sValue(26), intsValue(12));
riscv_genW_3(SP, intReg32sValue(27), intsValue(8));
		r = riscv_genDIV_4(r, a, b, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
