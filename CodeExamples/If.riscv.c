...
riscv_genW_3(SP, intReg32sValue(27), intsValue(8));
		threshold = riscv_genMV_2(threshold, (h2_sValue_t) {H2VALUE, 'i', 1, 31, 0, (int)((selectedValue))});
	#ifdef H2_DEBUG_REGISTER
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		value = riscv_genBNE_3(value, threshold, intsValue((labelAddresses [h2_iffalse_00000002] - h2_asm_pc)*4));
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
