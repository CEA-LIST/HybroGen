...
pifpii genAddArray2D(pifpii ptr, int stride, int constant) /* C compilette prototype */
{
	...
	h2_sValue_t nLine = {H2REGISTER, 'i', 1, 32, 1, true};
	h2_sValue_t nColumn = {H2REGISTER, 'i', 1, 32, 2, true};
	h2_sValue_t h2_outputVarName = {H2REGISTER, 'i', 1, 32, 0, true};
	h2_sValue_t line = {H2REGISTER, 'i', 1, 32, 9, true};
	h2_sValue_t column = {H2REGISTER, 'i', 1, 32, 10, true};
	h2_sValue_t sum = {H2REGISTER, 'i', 1, 32, 11, true};
...
h2_insn_t   * labelAddresses []={
	...
	h2_initRegisterMasks(0xFFFF0F07, 0, 0, 0);
	h2_resetRegisterMasks();
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask initialization\n");
	#endif // H2_DEBUG_REGISTER
	
		sum = aarch64_genMV_3(sum, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(0)}, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		line = aarch64_genMV_3(line, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(0)}, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		line = aarch64_genCMP_2(line, nLine);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		column = aarch64_genMV_3(column, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(0)}, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		column = aarch64_genCMP_2(column, nColumn);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
								tmp0003 = aarch64_genMUL_3(tmp0003, line, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)((stride))});
							tmp0004 = aarch64_genADD_3(tmp0004, tmp0003, column);
					...
					if (!tmp0005.dontFree) h2_freeReg(tmp0004.regNro);
						tmp0006 = aarch64_genADD_3(tmp0006, a, tmp0005);
				if (!tmp0006.dontFree) h2_freeReg(tmp0005.regNro);
				tmp0007 = aarch64_genR_3(tmp0007, tmp0006, immValueZero);
				tmp0008 = aarch64_genADD_3(tmp0008, sum, tmp0007);
		if (!tmp0008.dontFree) h2_freeReg(tmp0007.regNro);
		sum = aarch64_genADD_3(sum, tmp0008, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)((constant))});
	if (!sum.dontFree) h2_freeReg(tmp0008.regNro);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		column = aarch64_genADD_3(column, column, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(1)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		line = aarch64_genADD_3(line, line, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)(1)});
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
		h2_outputVarName = aarch64_genMV_3(h2_outputVarName, sum, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
