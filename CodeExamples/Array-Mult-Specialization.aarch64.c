...
pifi genMulArray(pifi ptr, int  b, int len)
{
	...
	h2_sValue_t l = {H2REGISTER, 'i', 1, 32, 10, true};
...
h2_insn_t   * labelAddresses []={
	...
	h2_initRegisterMasks(0xFFFF0701, 0, 0, 0);
	h2_resetRegisterMasks();
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask initialization\n");
	#endif // H2_DEBUG_REGISTER
	
		l = aarch64_genMV_3(l, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)((len))}, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	...
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
				tmp0002 = aarch64_genMUL_3(tmp0002, i, (h2_sValue_t) {H2VALUE, 'i', 1, 64, 0, (int)((1 * 32) / 8)});
				tmp0003 = aarch64_genADD_3(tmp0003, a, tmp0002);
		if (!tmp0003.dontFree) h2_freeReg(tmp0002.regNro);
						tmp0004 = aarch64_genMUL_3(tmp0004, i, (h2_sValue_t) {H2VALUE, 'i', 1, 64, 0, (int)((1 * 32) / 8)});
						tmp0005 = aarch64_genADD_3(tmp0005, a, tmp0004);
				if (!tmp0005.dontFree) h2_freeReg(tmp0004.regNro);
				tmp0006 = aarch64_genR_3(tmp0006, tmp0005, immValueZero);
			tmp0007 = aarch64_genMUL_3(tmp0007, tmp0006, (h2_sValue_t) {H2VALUE, 'i', 1, 32, 0, (int)((b))});
		if (!tmp0007.dontFree) h2_freeReg(tmp0006.regNro);
		aarch64_genW_3(tmp0003, tmp0007, immValueZero);
	#ifdef H2_DEBUG_REGISTER
	printf("Tmp registers mask reset\n");
	#endif // H2_DEBUG_REGISTER
	h2_resetRegisterMasks();
