...
#define P1_STFS_RRI_F_32_1(r1,r0,i0) do /* w */ { 	power_G32(((0x34 & 0x3f) << 26)|((r0 & 0x1f) << 21)|((r1 & 0x1f) << 16)|((i0 & 0xffff) >> 0)); } while(0);
#define P1_STFD_RRI_F_64_1(r1,r0,i0) do /* w */ { 	power_G32(((0x36 & 0x3f) << 26)|((r0 & 0x1f) << 21)|((r1 & 0x1f) << 16)|((i0 & 0xffff) >> 0)); } while(0);
...
if (isValue(P1))
  { // Store constant (Should use RRI variant)
    ...
    if ((P1.arith == 'f') && (P1.wLen <= 32) && (P1.vLen == 1) && P0.ValOrReg == H2REGISTER && P1.ValOrReg == H2REGISTER && P2.ValOrReg == H2VALUE)
    {
	P1_STFS_RRI_F_32_1(P0.regNro, P1.regNro, P2.valueImm);
	return P1;
    }

    if ((P1.arith == 'f') && (P1.wLen <= 64) && (P1.vLen == 1) && P0.ValOrReg == H2REGISTER && P1.ValOrReg == H2REGISTER && P2.ValOrReg == H2VALUE)
    {
	P1_STFD_RRI_F_64_1(P0.regNro, P1.regNro, P2.valueImm);
	return P1;
    }
...
h2_insn_t * gen_Array_St(h2_insn_t * ptr, int wordSize)
{
	...
	h2_sValue_t value = {H2REGISTER, 'f', 1, (wordSize), 1, true};
